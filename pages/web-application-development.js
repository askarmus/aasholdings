...
export default function WebApplicationnDevelopment() {
  return (
    ...
    <Layout meta={{ title: `Specialized to Create Robust Website and Applications - Ceyebx` }}>
      <main className="page-wrapper">
        <PageInnerHeader title={'Specialized to Create Robust Website and Applications.'} subTitle={"Web Development Services"} showButton={true} />
        <div className="">
    ...
    <br></br>
    <br></br>
Since 2015, MindInventory has been developing futuristic website and web applications that take businesses to greater heights. Our highly skilled web developers adopted a customer focused approach by upgrading their self to latest web technology like ReactJS, Angular, Node.js, .Net Core and many others.  
            ...
            <div className="col-lg-10 col-md-11">
              ...
              <div className="row mx-0">
               <div className="col-12 col-md-6 px-0 pr-md-5 pr-xl-0 mb-5 mb-md-0 native-app n-pr-100">
                  <h3 className="mb-4 type-title poppins-bold">Front End Web <span> Development </span></h3>
                  <p className="mb-3 mb-lg-5 my-2 robotoLight font-24 ">Front end or client-side development is the practice of managing everything that users visually see first in their application or browser.</p>
                  <div className="d-flex justify-content-between justify-content-xl-start  align-items-end mt-5">
                     <div className="service-item">
                        <div className="icon-box"><img loading="lazy" src="https://cdn3.iconfinder.com/data/icons/remixicon-logos/24/reactjs-fill-256.png" alt="React App Development" width={59} height={60} /></div>
                        <h4 className="regular-text mt-md-3"><span className="d-block">ReactJS</span> Development</h4>
                     </div>
                     <div className="service-item" >
                        <div className="icon-box"><img loading="lazy" src="https://cdn4.iconfinder.com/data/icons/logos-and-brands/512/367_Vuejs_logo-256.png" alt="Vuejs App Development" width={56} height={70} /></div>
                        <h4 className="regular-text mt-md-3"><span className="d-block">VueJS</span> Development</h4>
                     </div>
                     <div className="service-item"  >
                        <div className="icon-box"><img loading="lazy" src="https://cdn4.iconfinder.com/data/icons/logos-and-brands/512/21_Angular_logo_logos-256.png" alt="Angularjs App Development" width={66} height={70} /></div>
                        <h4 className="regular-text mt-md-3"><span className="d-block">Angular</span> Development</h4>
                     </div>
                  </div>
               </div>
               <div className="col-12 col-md-6 px-0 pr-md-5 pr-xl-0 n-pr-100 hybrid-app">
                  <h3 className="mb-4 type-title poppins-bold">Back End Web <span>Development</span></h3>
                  <p className="mb-3 mb-lg-5 my-2 robotoLight font-24 ">Backend or server-side development is responsible for managing data to ensure everything on the client-side actually works.</p>
                  <div className="d-flex justify-content-between justify-content-xl-start align-items-end mt-5">
                     <div className="service-item"  >
                        <div className="icon-box"><img loading="lazy" src="https://cdn4.iconfinder.com/data/icons/logos-and-brands/512/233_Node_Js_logo-256.png" alt="Nodejs App Development" width={57} height={70} /></div>
                        <h4 className="regular-text mt-md-3"><span className="d-block">Node.js</span> Development</h4>
                     </div>
                     <div className="service-item"  >
                        <div className="icon-box"><img loading="lazy" src="https://cutecdn.codingdojo.com/svg_images/curriculum/new_icon.svg" alt=".Net App Development" width={66} height={70} /></div>
                        <h4 className="regular-text mt-md-3"><span className="d-block">.Net</span> Development</h4>
                     </div>
                     <div className="service-item"  >
                        <div className="icon-box"><img loading="lazy" src="https://cdn4.iconfinder.com/data/icons/logos-and-brands/512/181_Java_logo_logos-256.png" alt="Java App Development" width={70} height={70} /></div>
                        <h4 className="regular-text mt-md-3"><span className="d-block">Java</span> Development</h4>
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div className="col py-4 my-2 my-sm-3">
              <div   className="card card-hover h-100 border-0 shadow-sm text-decoration-none pt-3 px-sm-3 px-md-0 px-lg-3 pb-sm-3 pb-md-0 pb-lg-3 me-xl-2">
                <div className="card-body  ">
                  ...
                  <p className="fs-sm text-body mb-0">We work on the latest frameworks and technologies to deliver you user-friendly, scalable, secure, and new business solutions as per your need.
           ...
           <div className="col py-4 my-2 my-sm-3">
              <div   className="card card-hover h-100 border-0 shadow-sm text-decoration-none pt-3 px-sm-3 px-md-0 px-lg-3 pb-sm-3 pb-md-0 pb-lg-3 me-xl-2">
                <div className="card-body  ">
                  ...
                  <p className="fs-sm text-body mb-0">We work on the Agile methodology and conduct frequent scrum events for optimizing the practices and methods and delivering the finest results.
            ...
            <div className="col py-4 my-2 my-sm-3">
              <div   className="card card-hover h-100 border-0 shadow-sm text-decoration-none pt-3 px-sm-3 px-md-0 px-lg-3 pb-sm-3 pb-md-0 pb-lg-3 me-xl-2">
                <div className="card-body  ">
                  ...
                  <p className="fs-sm text-body mb-0">TWe have a dedicated team of web app developers who are well versed in delivering high-end business solutions on several frameworks and technologies.
            ...
            <div className="col py-4 my-2 my-sm-3">
              <div   className="card card-hover h-100 border-0 shadow-sm text-decoration-none pt-3 px-sm-3 px-md-0 px-lg-3 pb-sm-3 pb-md-0 pb-lg-3 me-xl-2">
                <div className="card-body  ">
                  ...
                  <p className="fs-sm text-body mb-0">We respect your ideas and vision, provide you every small project detail regularly, and consider your worthy advice when and as needed.
