export const Footer = () => (
    <footer className="footer dark-mode bg-dark pt-5 pb-4 pb-lg-5">
      ...
      <div className="row gy-4"><div className="col-lg-4 col-xl-3 pe-xl-5 mb-5 mb-lg-0"><div className="pb-3"> </div><p className="m-0 text-white">NAVDECK offers the full spectrum of custom software development services to fit the varied needs of our customers. Build better software, faster!
      ...
      <hr class="mt-3 mb-3" />
    <div className="col-10 col-lg-8   mb-4 footer-location"><div className="row mx-0 align-items-center"><div className="col-12 col-md-12 col-xl-3 pr-0 pl-xl-5"><a href="/"><img width={114} height={41} src="assets/image/logo.svg" alt="mi logo" className="footer-logo" loading="lazy" /></a></div><div className="col-12 col-md-6 col-xl-6 pr-0 pl-xl-5"><div className="communication-location r-communication-address"><span className="d-flex"><div className="footer-icons"><img src="https://www.mindinventory.com/static/media/address.d4c78826.svg" alt="address" /></div> India</span><p>801, City Centre 2,</p><p>Science City Road, Sola-380060</p><p>Ahmedabad, Gujarat, India</p></div></div><div className="col-12 col-md-6 col-xl-3 pr-0 pl-xl-0"><div className="communication-location"><span className="d-flex"><div className="footer-icons"><img src="https://www.mindinventory.com/static/media/address.d4c78826.svg" alt="address" /></div> USA</span><p>9341 Ellis Way, Strongsville,</p><p>Ohio 44136</p><p>USA</p></div></div></div></div>
